---
name: pdf-processing
description: Comprehensive PDF manipulation toolkit for extracting text and tables, creating new PDFs, merging/splitting documents, and handling forms. Use when working with PDF files, filling forms, extracting data from PDFs, or programmatically processing PDF documents.
---
...
**Skill directory**: `~/.cursor/skills/pdf-processing`
